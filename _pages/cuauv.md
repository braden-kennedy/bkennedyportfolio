...
{% include figure.html src="cuauv/Competition_TeamPic.PNG" alt=" " caption="A picture of the CUAUV summer team at the RoboSub 2024 competition. Only a handful of members, mostly freshmen, stayed in Ithaca during the summer to conduct the final assembly of our AUVs and travel with them to competition. I was responsible for coordinating our in-person teams with other members who were remote, and made many time-sensitive decisions at Robosub which earned us 3rd place overall." position="wide" width="80%" %}
...
{% include figure.html src="cuauv/Downcam_Drawing.JPG" alt=" " caption="The pre-preliminary design review drawings for my camera enclosure." position="right" width="300px" %}
