...
{% include figure.html src="other/Cavendish_Tracker.JPG" alt=" " caption="The Physics Tracker program following the dot of the laser against the wall in 0.2 second increments. I fit a damped sinusoidal to resulting motion to extract *G*, the gravitational constant." position="left" width="300px" %}
